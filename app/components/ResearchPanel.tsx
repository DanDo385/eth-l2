...
export function ResearchPanel({ mode = "all" }: Props) {
  ...
  return (
    <div className="space-y-3 rounded-xl border border-zinc-800 bg-zinc-900 p-3 sm:p-4">
      <div>
        <p className="text-xs uppercase tracking-wide text-zinc-400">Proof lab</p>
      ...
      <section className="border-t border-zinc-800 pt-3 space-y-2">
        ...
        <ol className="space-y-1.5 text-sm text-zinc-400 leading-relaxed list-decimal list-inside">
